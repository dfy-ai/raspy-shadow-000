...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/imagen
```

A live public deployment of this template is available at [https://imagen.templates.workers.dev](https://imagen.templates.workers.dev)
